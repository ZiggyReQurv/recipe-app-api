...
def create_user(**params):
    ...
    # create_user is the user module in module.py
...
class PublicUserAPITests(TestCase):
    ...
    def test_create_token_for_users(self):
        ...
        user_details = {
            'name': 'Test Name',
            'email': 'test@example.com',
            'password': 'test-user-passwrod123',
        }
    ...
    def test_create_token_bad_credetnials(self):
        ...
        create_user(email='test@exampe.com', password='goodpass')

        payload = {'email': 'test@exampe.com', 'password': 'badpass'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_blank_password(self):
        ...
        payload = {'email': 'test@exampe.com', 'password': '' }
        res = self.client.post(TOKEN_URL, payload)
